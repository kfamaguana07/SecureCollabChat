...
export const emitDeleteMessage = (mensaje_id, sala_id, sesion_id)             => getSocket().emit(SOCKET_EVENTS.DELETE_MESSAGE,  { mensaje_id, sala_id, sesion_id });
...
export const onMessageDeleted      = (cb) => on(SOCKET_EVENTS.MESSAGE_DELETED,       cb);